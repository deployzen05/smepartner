...
export function Navbar() {
  ...
  return (
    <>
      ...
      <nav className="fixed top-0 right-0 left-0 z-40 bg-white/50 backdrop-blur-md md:top-10">
        <div className="max-w-8xl container mx-auto flex h-15 items-center justify-between px-4 md:px-6">
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            >
              ...
              <div className="mb-4 flex flex-col gap-4 border-b border-orange-100 pb-4">
                <div className="flex flex-col flex-wrap items-center gap-1 text-center">
