  ...
  left: [
    {
      ...
      description:
        'We manage all required paperwork and approvals to ensure your subsidy application is compliant and accepted flawlessly.',
    },
    {
      title: 'Capital & Interest Subsidies',
      description:
        'Expert guidance through available industrial subsidies, including MSME policies, food processing, and state tech upgradation.',
    },
  ],
  right: [
    {
      title: 'Registered with IIA',
      description:
        'Registered with the Indian Industries Association (IIA), ensuring compliance and dedicated subsidy support.',
    },
    {
      title: 'Direct Department Liaison',
      description:
        'Our dedicated team liaises directly with government departments to streamline the approval process and expedite disbursements.',
    },
  ],
};

export function SubsidyUSP() {
  return (
