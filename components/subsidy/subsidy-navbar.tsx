...
export function SubsidyNavbar() {
  ...
  const subsidyLinks = [
    { title: 'Food Processing', href: '/subsidy/food-processing', description: 'Capital subsidy up to 35% for food processing units', icon: Factory },
    { title: 'PMFME Scheme', href: '/subsidy/pmfme-scheme', description: 'Support for micro food processing enterprises', icon: Building2 },
    { title: 'MSME Policy', href: '/subsidy/msme', description: 'Comprehensive subsidies for MSMEs in Uttar Pradesh', icon: Briefcase },
    { title: 'UP Tourism', href: '/subsidy/up-tourism', description: 'Incentives for hotels, resorts, and tourism projects', icon: MapPin },
    { title: 'Tech Upgradation', href: '/subsidy/tech-upgradation', description: '50% capital and interest subsidy for modernization', icon: Zap },
    { title: 'Dairy Development', href: '/subsidy/dairy-development', description: 'Nand Baba Dairy Mission benefits and subsidies', icon: Milk },
  ];
