...
import { WhatWeOfferGrid } from '@/components/solar/what-we-offer-grid';

export function WhatWeOffer() {
  return (
    <section id="what-we-offer" className="bg-white py-10 md:py-12">
      <div className="mx-auto max-w-7xl px-4">
        ...
        >
          ...
          <h2 className="mb-3 text-xl font-bold leading-tight text-balance text-orange-600 md:text-3xl">
            What We Offer
          </h2>
