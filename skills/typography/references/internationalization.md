...
<html lang="ar" dir="rtl">
  ...
  <div dir="rtl" lang="ar">المحتوى العربي هنا</div>
</html>
```
...
.japanese {
  font-family:
    'Noto Sans JP', 'Hiragino Kaku Gothic Pro', 'Yu Gothic', 'Meiryo',
    sans-serif;
}
...
body {
  font-family:
    'Inter',
    /* Latin primary */ 'Noto Sans',
    /* Latin fallback */ 'Noto Sans Arabic',
    'Noto Sans Hebrew',
    'Noto Sans SC',
    /* Chinese Simplified */ 'Noto Sans JP',
    /* Japanese */ 'Noto Sans KR',
    /* Korean */ system-ui,
    sans-serif;
}
```
...
```html
<p dir="rtl">النص العربي with English words يعود إلى العربية</p>
```
...
```html
<p dir="rtl">الهاتف: <span dir="ltr">+1 (555) 123-4567</span></p>
```
...
<html lang="ar" dir="rtl" class="rtl">
  ...
  <div class="ms-4 border-e ps-2 text-start">RTL-aware component</div>
</html>
```
