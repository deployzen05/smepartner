...
```html
<article class="prose dark:prose-invert">Inverted colors in dark mode</article>
...
```html
<article
  class="prose prose-headings:text-blue-600 prose-a:text-blue-500 prose-a:no-underline prose-a:hover:underline prose-strong:text-gray-900 prose-code:text-pink-500 prose-code:before:content-none prose-code:after:content-none prose-img:rounded-xl prose-img:shadow-lg prose-blockquote:border-blue-500 prose-blockquote:italic prose-li:marker:text-blue-500"
>
  <!-- Content -->
</article>
```
...
```html
<article class="prose max-w-none">Full-width prose content</article>
```
...
<!-- Heading hierarchy -->
<h1
  class="text-4xl leading-tight font-bold tracking-tight md:text-5xl lg:text-6xl"
>
  Page Title
</h1>

<h2 class="text-2xl leading-snug font-semibold tracking-tight md:text-3xl">
  Section Title
</h2>

<h3 class="text-xl leading-snug font-semibold md:text-2xl">Subsection</h3>

<p class="text-base leading-relaxed text-gray-700">
  Body paragraph with comfortable reading line height.
</p>

<p class="text-sm leading-normal text-gray-500">Caption or secondary text.</p>
```
...
```html
<h1
  class="text-2xl leading-tight sm:text-3xl md:text-4xl lg:text-5xl lg:leading-none xl:text-6xl"
>
  Responsive Heading
</h1>
```
...
```html
<header class="mb-8">
  <span class="text-sm font-medium tracking-wider text-blue-600 uppercase">
    Technology
  </span>
  <h1
    class="mt-2 text-3xl leading-tight font-bold text-balance text-gray-900 md:text-4xl"
  >
...
```html
<h3 class="line-clamp-2 text-lg leading-snug font-semibold text-gray-900">
...
```html
<td class="text-right text-sm tabular-nums">1,234,567</td>
```
...
```html
<article
  class="prose prose-gray dark:prose-invert dark:prose-p:text-gray-300 dark:prose-headings:text-white dark:prose-a:text-blue-400"
>
  <!-- Content -->
</article>
```
...
```html
<article
  class="prose prose-lg prose-headings:font-display prose-headings:text-gray-900 prose-a:text-blue-600 prose-a:no-underline hover:prose-a:underline prose-blockquote:border-l-blue-500 prose-blockquote:text-gray-700 prose-code:rounded prose-code:bg-gray-100 prose-code:px-1 prose-code:py-0.5 prose-pre:bg-gray-900 prose-img:rounded-lg prose-img:shadow-md dark:prose-invert mx-auto max-w-prose"
>
...
<!-- Recommended -->
<article
  class="prose prose-gray lg:prose-lg dark:prose-invert mx-auto max-w-prose"
>
  ...
</article>
...
<!-- Full-featured -->
<article
  class="prose prose-gray prose-sm md:prose-base lg:prose-lg dark:prose-invert prose-headings:text-balance prose-p:text-pretty prose-a:text-blue-600 mx-auto max-w-prose px-4"
>
  ...
</article>
```
