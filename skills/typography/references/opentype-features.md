...
.inter-recommended {
  font-feature-settings:
    ...
    /* Kerning */ 'liga' 1,
    /* Ligatures */ 'calt' 1,
    /* Contextual alternates: arrows, emoticons */ 'ss02' 1; /* Disambiguation: distinct l, 1, I */
}
...
.inter-code {
  font-feature-settings:
    ...
    'calt' 1,
    'tnum' 1,
    /* Tabular numbers */ 'zero' 1,
    /* Slashed zero */ 'cv05' 1; /* L with tail */
}
```
...
.source-serif-editorial {
  font-feature-settings:
    ...
    'liga' 1,
    'onum' 1,
    /* Old-style figures */ 'pnum' 1; /* Proportional figures */
}
```
