          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-4">
                {[
                  'Capital Subsidy: 50% of capital expenditure on adopting modern machinery.',
                  'Interest Subsidy: 50% interest subsidy on machinery loans for 5 years.',
