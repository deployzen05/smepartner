          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-20">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg leading-relaxed text-slate-600">
                The Uttar Pradesh government offers substantial incentives to encourage 
                investment in the state's food processing sector. From setting up new 
                facilities to adopting solar power, discover what benefits your unit can claim.
              </p>
